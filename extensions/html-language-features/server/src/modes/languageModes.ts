...
import type { DocumentContext, IHTMLDataProvider } from 'vscode-html-languageservice';

const getCSSLanguageService = cssLs.getCSSLanguageService;
const getHTMLLanguageService = htmlLs.getLanguageService;
type HtmlClientCapabilities = htmlLs.ClientCapabilities;
...
export const ClientCapabilities = htmlLs.ClientCapabilities;
export const TokenType = htmlLs.TokenType;

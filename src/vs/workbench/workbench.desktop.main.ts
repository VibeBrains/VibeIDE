...
// Surveys
// [VibeIDE removed] опросы Microsoft
...
// [VibeIDE removed] туннель-хост агентских сессий
// import './contrib/chat/electron-browser/tunnelHost.contribution.js';

// Copilot Voice
// [VibeIDE removed] голосовой режим Copilot
...
import './contrib/vibeide/electron-browser/vibeRunDiffService.js';

...
/** VibeIDE: empty-editor watermark uses our chat command so the hint matches the real shortcut. */
const openChat: WatermarkEntry = { text: localize('watermark.openChat', "Open Chat"), id: 'vibeide.sidebar.open' };

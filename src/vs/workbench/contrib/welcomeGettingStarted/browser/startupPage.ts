...
export class StartupPageRunnerContribution extends Disposable implements IWorkbenchContribution {
	...
	private tryShowOnboarding(): void {
		...
		// VibeIDE: skip Microsoft "Welcome to VS Code" / GitHub Copilot sign-in wizard; product uses VibeIDE onboarding instead.
		if (this.productService.applicationName === 'vibeide') {
			return;
		}

...
export const EDIT_FILE_TOOL: ToolDef<'edit_file'> = {
	...
	params: {
		...
		new_string: { description: `PREFERRED. The replacement text for old_string. Inserted VERBATIM — the tool does NOT re-indent. Keep the EXACT indentation you want on EVERY line, including the FIRST line (a common mistake is omitting the first line's leading whitespace). To delete, pass an empty string. Required when old_string is given.` },

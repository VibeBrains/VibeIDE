...
Примечание: если включён VERIFY-GATE, этот вызов АВТОМАТИЧЕСКИ прогонит проверочную команду (сборка/тесты); при её падении ход НЕ завершится, и ты получишь вывод ошибки на доработку.`,
	params: {

	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--vibe-fg-1)',
						'--tw-prose-headings': 'var(--vibe-fg-1)',
						'--tw-prose-lead': 'var(--vibe-fg-2)',
						'--tw-prose-links': 'var(--vibe-link-color)',
						'--tw-prose-bold': 'var(--vibe-fg-1)',
						'--tw-prose-counters': 'var(--vibe-fg-3)',
						'--tw-prose-bullets': 'var(--vibe-fg-3)',
						'--tw-prose-hr': 'var(--vibe-border-4)',
						'--tw-prose-quotes': 'var(--vibe-fg-1)',
						'--tw-prose-quote-borders': 'var(--vibe-border-2)',
						'--tw-prose-captions': 'var(--vibe-fg-3)',
						'--tw-prose-code': 'var(--vibe-fg-0)',
						'--tw-prose-pre-code': 'var(--vibe-fg-0)',
						'--tw-prose-pre-bg': 'var(--vibe-bg-1)',
						'--tw-prose-th-borders': 'var(--vibe-border-4)',
						'--tw-prose-td-borders': 'var(--vibe-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'vibe-bg-1': 'var(--vibe-bg-1)',
				'vibe-bg-1-alt': 'var(--vibe-bg-1-alt)',
				'vibe-bg-2': 'var(--vibe-bg-2)',
				'vibe-bg-2-alt': 'var(--vibe-bg-2-alt)',
				'vibe-bg-2-hover': 'var(--vibe-bg-2-hover)',
				'vibe-bg-3': 'var(--vibe-bg-3)',


				'vibe-fg-0': 'var(--vibe-fg-0)',
				'vibe-fg-1': 'var(--vibe-fg-1)',
				'vibe-fg-2': 'var(--vibe-fg-2)',
				'vibe-fg-3': 'var(--vibe-fg-3)',
				// 'vibe-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'vibe-fg-4': 'var(--vibe-fg-4)',

				'vibe-warning': 'var(--vibe-warning)',

				'vibe-border-1': 'var(--vibe-border-1)',
				'vibe-border-2': 'var(--vibe-border-2)',
				'vibe-border-3': 'var(--vibe-border-3)',
				'vibe-border-4': 'var(--vibe-border-4)',

				'vibe-ring-color': 'var(--vibe-ring-color)',
				'vibe-link-color': 'var(--vibe-link-color)',

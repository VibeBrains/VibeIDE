 ...
 *--------------------------------------------------------------------------------------
 *
 * Injects bundled `media/vibe-neon*.css` when Vibe Neon themes are active.
 * Resolves the extension root from the active ColorThemeData JSON path (no reliance on

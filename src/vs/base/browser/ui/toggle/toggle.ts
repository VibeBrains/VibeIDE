...
export interface IToggleOpts extends IToggleStyles {
	...
	/** When true, checked/unchecked visuals use CSS only (no border/color/bg on domNode.style). */
	readonly skipInlineCheckedStyles?: boolean;
}
...
export class Toggle extends Widget {
	...
	protected applyStyles(): void {
		...
		if (this._opts.skipInlineCheckedStyles) {

...
<p align="center">
  ...
  <a href="https://github.com/VibeIDETeam/VibeIDE/releases"><img src="https://img.shields.io/badge/версия-1.2.0-green.svg" alt="Версия" /></a>
...
- Свои LLM-провайдеры через `.vibe/providers.json` — добавить, переопределить или выключить провайдера и модели **без пересборки IDE** (ключ через `apiKeyEnv`/`apiKeyRef`, патч встроенных, `extends`, порядок). Подробности — в разделе [«Свои провайдеры»](#свои-провайдеры--vibeprovidersjson) ниже.

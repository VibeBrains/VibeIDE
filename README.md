...
- **Краткие ответы** — включены сразу: агент отвечает коротко, но каждый технический факт, код и текст ошибки остаются дословно; код, коммиты и документация пишутся обычной речью. Уровень и остальные частые ручки — в меню быстрых настроек под полем чата.

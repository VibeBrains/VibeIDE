...
> **Удалить этот шаблонный блок.** Копировать в `docs/knowledge/<подходящий-topic>/<short-slug>.md`. Подходящие topic'и для инцидентов: `runtimeQuirks/`, `chatUx/`, `architecture/`, `build/`.

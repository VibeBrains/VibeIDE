...
| [designReview.md](ui/designReview.md) | Детерминированные детекторы «сгенерированного» вида (21 правило поверх снимка вычисленных стилей) + словарь команд вместо «сделай красивее»; ловушки: диапазон hue промахивался мимо канонического #7C5CFF, цвет полосы считается по израсходованной доле |

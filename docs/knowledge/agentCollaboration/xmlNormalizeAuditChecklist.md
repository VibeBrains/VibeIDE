...
# 4. Add catalog запись в docs/knowledge/runtimeQuirks/xmlToolFormatIncidents.md
...
- [xmlToolNormalization.md](../architecture/xmlToolNormalization.md) — architecture overview
- [xmlToolFormatIncidents.md](../runtimeQuirks/xmlToolFormatIncidents.md) — catalog of observed formats

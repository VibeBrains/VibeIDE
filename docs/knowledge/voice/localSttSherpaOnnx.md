...
- **Тест wav для смоука без микрофона**: `say -v Milena "…" -o x.aiff && afconvert -f WAVE -d LEI16@16000 -c 1 x.aiff x.wav` — весь пайплайн (T-one partials → endpoint → GigaAM final) проверяется на синтетической русской речи.

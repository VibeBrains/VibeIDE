 ...
 *
 * See: docs/knowledge/i18n/languagePack.md and i18n/nlsIndices.md
 */
...
Full playbook: docs/knowledge/i18n/languagePack.md`);
}
...
function cmdVerify() {
	...
	console.error('  Fix: npm run nls-extract, clear dev clp, full Electron restart (see docs/knowledge/i18n/nlsIndices.md)');
	process.exit(1);
}
